    ...
    contents: [
      {
        type: ContentType.Text,
        content:
          "抖音美团商战啦。昨天，“太二酸菜鱼”在抖音首次直播，售卖了1个亿的营业额呢。今天，在大众点评上就搜不到“太二”了。",
      },
    ],
  },
  {
    ...
    contents: [
      {
        type: ContentType.Text,
        content:
          "亲爱的商户大人，中午的忙碌时光已经结束了，您今天的努力真是让人感到自豪！不知道您是否想要查看您的中午外卖订单的满意度呢？",
      },
    ],
  },
    ...
    contents: [
      {
        type: ContentType.Text,
        content:
          "太好了！不过，在为您展示这些宝贵的反馈之前，我需要您的一点小小授权。只需确认您是本店的合法所有者或经理，就可以了。只要点击下面的授权按钮就可以完成授权哦，授权完成后，我们将为您立刻查找相关的评价。如果您还有其他需要，也随时告诉我哦！",
      },
    ],
  },
  {
    ...
    contents: [
      {
        type: ContentType.Text,
        content:
          "这条差评主要是针对米饭口感的，建议您这样回复：“亲爱的顾客您好，抱歉让您有了不好的消费体验，非常感谢您对我们的菜品的评价和关注，您的意见我们已收到，会尽快调整米饭口感。”",
      },
    ],
  },
  {
